        ...
        <div class="card-body">
            <form method="post" action="{{ route('wrestlers.store') }}">
                ...
                <div class="mb-10">
                    <div class="mb-5 row gx-10">
                        <div class="col-lg-3">
                            ...
                            <input type="number" name="feet" class="form-control" placeholder="6">
                            @error('feet')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                            @enderror
                        </div>
                        <div class="col-lg-3">
                            ...
                            <input type="number" name="inches" class="form-control" placeholder="2">
                            @error('inches')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                            @enderror
                        </div>
                        <div class="col-lg-6">
                            ...
                            <input type="number" name="weight" class="form-control" placeholder="6">
                            @error('weight')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                            @enderror
                        </div>
                ...
                <div class="mb-10">
                    ...
                    <input type="text" name="hometown" class="form-control" placeholder="Orlando, FL">
                    @error('hometown')
                        <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                    @enderror
                </div>
