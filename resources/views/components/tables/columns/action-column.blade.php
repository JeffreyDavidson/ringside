<div class="flex" x-data="{ open: false, toggle() { this.open = !this.open } }" @click.outside="open = false">
    <div class="flex flex-col p-0 m-0">
        <button x-ref="button" @click="toggle()" class="inline-flex items-center cursor-pointer rounded-md leading-none border border-transparent border-solid border-1 h-8 w-8 font-medium text-xs justify-center p-0 gap-0 shrink-0 grow">
