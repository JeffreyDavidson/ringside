<div class="h-[70px] hidden items-center relative justify-between px-3 shrink-0 lg:flex lg:px-6">
    ...
    <x-button withIcon class="size-[30px] rounded-lg border-gray-200 bg-light text-gray-500 hover:text-gray-700 absolute start-full top-2/4 -translate-x-2/4 -translate-y-2/4">
