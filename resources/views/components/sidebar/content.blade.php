<div id="sidebar-content" class="flex grow shrink-0 py-5 pe-2" :class="!sidebarIsOpen ? 'lg:overflow-hidden' : ''">
    <div
        class="relative scrollbar-thin scrollbar-transparent overflow-y-scroll grow shrink-0 flex ps-2 lg:ps-5 pe-1 lg:pe-3">
        <!-- Sidebar Menu -->
        <x-sidebar.menu class="flex flex-col grow gap-0.5">
            <x-sidebar.menu-item>
                <x-sidebar.menu-label>
                    <x-sidebar.menu-icon icon="ki-element-11" />
                    <x-sidebar.menu-link x-show="sidebarIsOpen" x-cloak href="{{ route('dashboard') }}" :isCurrent="request()->routeIs('dashboard')">
                        Dashboard
                    </x-sidebar.menu-link>
                </x-sidebar.menu-label>
            </x-sidebar.menu-item>
            ...
            <div x-data="{
                sidebarIsOpen: @json(request()->is('roster/*')),
                toggle() {
            ...
            <x-sidebar.menu-item>
                <x-sidebar.menu-label>
                    ...
                    <x-sidebar.menu-link x-show="sidebarIsOpen" x-cloak :href="route('titles.index')" :isCurrent="request()->routeIs('titles.*')">
                        Titles
                    </x-sidebar.menu-link>
                </x-sidebar.menu-label>
            </x-sidebar.menu-item>
            <x-sidebar.menu-item>
                <x-sidebar.menu-label>
                    ...
                    <x-sidebar.menu-link x-show="sidebarIsOpen" x-cloak :href="route('venues.index')" :isCurrent="request()->routeIs('venues.*')">
                        Venues
                    </x-sidebar.menu-link>
                </x-sidebar.menu-label>
            </x-sidebar.menu-item>
            <x-sidebar.menu-item>
                <x-sidebar.menu-label>
                    ...
                    <x-sidebar.menu-link x-show="sidebarIsOpen" x-cloak :href="route('events.index')" :isCurrent="request()->routeIs('events.*')">
                        Events
                    </x-sidebar.menu-link>
                </x-sidebar.menu-label>
            </x-sidebar.menu-item>
