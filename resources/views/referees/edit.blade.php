            ...
            <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                ...
                <div class="flex-wrap page-title d-flex flex-column justify-content-center me-3">
                    ...
                    <ul class="pt-1 my-0 breadcrumb breadcrumb-separatorless fw-semibold fs-7">
                        ...
                        <li class="breadcrumb-item text-muted">
                            <a href="{{ route('referees.show', $referee) }}" class="text-muted text-hover-primary">{{ $referee->full_name }}</a>
                        </li>
                        <li class="breadcrumb-item">
                            <span class="bg-gray-400 bullet w-5px h-2px"></span>
                        </li>
        ...
        <div class="card-body">
            <form method="post" action="{{ route('referees.update', $referee) }}">
                ...
                <div class="mb-10">
                    <div class="mb-5 row gx-10">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="first_name" class="form-control" placeholder="Referee First Name Here" value="{{ $referee->first_name }}">
                            @error('first_name')
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="last_name" class="form-control" placeholder="Referee Last Name Here" value="{{ $referee->last_name }}">
                            @error('last_name')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                            @enderror
                        </div>
                ...
                <div class="mb-10">
                    ...
                    {{-- @dd($referee->started_at->format('Y/m/d')) --}}
                    <input type="date" name="start_date" class="form-control" placeholder="MM-DD-YYYY" value="{{ $referee->started_at?->format('Y-m-d') }}">
                    @error('start_date')
                        <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                    @enderror
                </div>
