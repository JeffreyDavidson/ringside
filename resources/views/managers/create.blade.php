                ...
                <div class="mb-10">
                    <div class="mb-5 row gx-10">
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="first_name" class="form-control" placeholder="Manager First Name Here">
                            @error('first_name')
                        ...
                        <div class="col-lg-6">
                            ...
                            <input type="text" name="first_name" class="form-control" placeholder="Manager Last Name Here">
                            @error('last_name')
                                <div class="fv-plugins-message-container invalid-feedback"><div data-field="name" data-validator="notEmpty">{{ $message }}</div></div>
                            @enderror
                        </div>
