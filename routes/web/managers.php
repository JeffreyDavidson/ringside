...
use App\Http\Controllers\Managers\RecoverFromInjuryController;
...
Route::put('/managers/{manager}/recover', RecoverFromInjuryController::class)->name('managers.recover');
