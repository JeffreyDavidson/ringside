...
class ViewStablesSuccessConditionsTest extends TestCase
{
    ...
    public function a_super_administrator_can_view_bookable_stables()
    {
        ...
        $responseAjax = $this->ajaxJson(route('stables.index', ['status' => 'only_bookable']));
    ...
    public function a_super_administrator_can_view_pending_introduced_stables()
    {
        ...
        $responseAjax = $this->ajaxJson(route('stables.index', ['status' => 'only_pending_introduction']));
    ...
    public function a_super_administrator_can_view_retired_stables()
    {
        ...
        $responseAjax = $this->ajaxJson(route('stables.index', ['status' => 'only_retired']));
