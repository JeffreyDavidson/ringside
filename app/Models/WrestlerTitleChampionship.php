 ...
 */
class WrestlerTitleChampionship extends Model
{
    /** @use HasFactory<\Database\Factories\WrestlerTitleChampionshipFactory> */
    use HasFactory;
     ...
     * @var string
     */
    protected $table = 'wrestlers_title_championships';
     ...
     *
     * @return BelongsTo<Wrestler, WrestlerTitleChampionship>
     */
    public function currentChampion(): BelongsTo
    {
        return $this->belongsTo(Wrestler::class, 'new_champion_id');
    }
    ...
    {
        return $this->belongsTo(Wrestler::class, 'former_champion_id');
    }
