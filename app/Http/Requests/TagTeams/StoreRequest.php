...
class StoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'signature_move' => ['nullable', 'required_with_all:wrestlerA,wrestlerB', 'string', 'regex:/^[a-zA-Z\s\']+$/'],
            'start_date' => ['nullable', 'string', 'date'],
            'wrestlerA' => ['nullable', 'integer', 'different:wrestlerB', 'required_with:wrestlerB', Rule::exists('wrestlers', 'id'), new WrestlerCanJoinNewTagTeam()],
            'wrestlerB' => ['nullable', 'integer', 'different:wrestlerA', 'required_with:wrestlerA', Rule::exists('wrestlers', 'id'), new WrestlerCanJoinNewTagTeam()],
        ];
    }
